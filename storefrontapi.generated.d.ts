...
export type FlavorProductFragment = Pick<
  StorefrontAPI.Product,
...
export type AllFlavorsQueryVariables = StorefrontAPI.Exact<{
  first: StorefrontAPI.Scalars['Int']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type AllFlavorsQuery = {
  products: {
    nodes: Array<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  fragment FlavorProduct on Product {\n    id\n    handle\n    title\n    vendor\n    featuredImage {\n      id\n      url\n      altText\n      width\n      height\n    }\n    priceRange {\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n      maxVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n    variants(first: 1) {\n      nodes {\n        id\n        title\n        availableForSale\n        quantityAvailable\n        price {\n          amount\n          currencyCode\n        }\n      }\n    }\n  }\n\n  query AllFlavors(\n    $first: Int!\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    products(first: $first) {\n      nodes {\n        ...FlavorProduct\n      }\n    }\n  }\n': {
    return: AllFlavorsQuery;
    variables: AllFlavorsQueryVariables;
  };
